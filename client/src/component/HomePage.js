     ...
     <header className="showcase">
       <div className="grid-2bis">
         <div style={{zIndex:1}} className="col-md-3 col-sm-3 col-xs-6 ">
          <Link to='/login'><a href="#" className="btn btn-sm animated-button victoria-two">Login</a></Link>
         </div>
         <div style={{zIndex:1}} className="col-md-3 col-sm-3 col-xs-6 ">
         <Link to='/signup'><a href="#" className="btn btn-sm animated-button victoria-two">SignUp</a></Link> </div>
       </div>
